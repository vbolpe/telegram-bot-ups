...
class SNMPConfig:
    ...
    OIDS = {
        ...
        'battery_capacity': os.getenv('OID_UPS_BATTERY_CAPACITY', '1.3.6.1.2.1.33.1.2.4.0'),
        'battery_runtime': os.getenv('OID_UPS_BATTERY_RUNTIME', '1.3.6.1.2.1.33.1.2.3.0'),

        #Mediciones eléctricas entrada/salida
        ...
        'temperature': os.getenv('OID_UPS_TEMPERATURE', '1.3.6.1.2.1.33.1.2.7.0'),
        'bypass_voltage': os.getenv('OID_UPS_BYPASS_VOLTAGE'),

        #Alarmas y eventos
        'alarms': os.getenv('OID_UPS_ALARMS', '1.3.6.1.2.1.33.1.6.1.0'),
    }
